              ...
              <div className="card-body">
                ...
                <form onSubmit={formik.handleSubmit}>
                                ...
                                <label htmlFor>Title</label>
                                        ...
                                        <input type="text" placeholder="Testimonial's Title" name="testimonialTitle" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.testimonialTitle} className="form-control" required  />
                                        {formik.errors.testimonialTitle && formik.touched.testimonialTitle ? (<div className='error'>{formik.errors.testimonialTitle}</div>) : null}
                                ...
                                <div className="containerTestimonialButton mt-3 mb-3">
                                  <button  type="submit" className="btnTestimonialButton play-pause buttonTestimonialButton" style = {{fontWeight : "bold" }}>
                                    Create Testimonial
                                  </button>
                                </div>
                                </center>
