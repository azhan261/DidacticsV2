...
function CoursePlanningContentForTeacher() {
  ...
  const onSubmitHandler = async (data) => {
    ...
    if ((data.coursetype == "English") && (data.questiontype === "Text") && (data.answertype === "Text")){
      history.push({
        pathname:"/teacher/adult-course-content-text-qa",
        state: data
      })
    }
    else if ((data.coursetype == "English") && (data.questiontype === "Text") && (data.answertype === "Multiple Choice")){
      history.push({
        pathname:"/teacher/adult-course-content-text-mcq",
        state: data
      })
    }
    else if ((data.coursetype == "English") && (data.questiontype === "Text") && (data.answertype === "Fill in the Blanks")){
      history.push({
        pathname:"/teacher/adult-course-content-text-blanks",
        state: data
      })
    } else if ((data.coursetype == "English") && (data.questiontype === "Text") && (data.answertype === "Pronunciation")){
      history.push({
        pathname:"/teacher/adult-course-content-text-pronunciation",
        state: data
      })
    }
    else if ((data.coursetype == "English") && (data.questiontype === "Text") && (data.answertype === "HandWriting")){
      history.push({
        pathname:"/teacher/adult-course-content-text-handwriting",
        state: data
      })
    }
    else if ((data.coursetype == "English") && (data.questiontype === "File Upload")){
      history.push({
        pathname:"/teacher/adult-course-content-file-upload",
        state: data
      })
    }
