...
function PronunciationForTestForTeacher() {
      ...
      <Row>
        <Col md="12">
          <Card className="card-plain">
            <CardHeader>{location.state.grade} Pronunciation Course Content Creation Panel</CardHeader>
            <CardBody>
                  <div className="mt-3 mb-3">
                      <h3>Please create your desired Pronunciation Question</h3>
                  </div>
                  <Editor
...
export default PronunciationForTestForTeacher
