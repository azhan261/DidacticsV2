    ...
    return (
        <div>            <i class="fas fa-info-circle"></i>
            <section id="hero" className="contact">
                ...
                <h1><span><i className="fas fa-info-circle fa-lg"></i></span><span style = {{paddingLeft : "15px", fontWeight : "bold"}}>Contact Us</span></h1>
                     ...
                     */}
                      <form   className="php-email-form" data-aos="fade-up" onSubmit={formik.handleSubmit} >
                        ...
                        <div className="text-center mt-3">
                          <button type="submit"><i className="fa fa-envelope fa-lg"></i> <span style = {{paddingLeft : "15px", fontWeight : "bold"}}>Send Message</span></button>
                        </div>
