                ...
                <div className="row">
                      ...
                      <div className="col-md-6 mt-3">
                        <div className="form-group">
                          ...
                          <select name="subjects" onChange={formik.handleChange}  onBlur={formik.handleBlur} value={formik.values.subjects} className="form-control" required>
                    ...
                    <div className="col-md-6 mt-3">
                      <div className="form-group">
                        ...
                        <div>
                        <input type="file" name="cv" className="form-control mt-3" required  onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.cv} />
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6 mt-3">
                      <div className="form-group">
                        ...
                        <input type="file" name="image" className="form-control" required  onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.image} />
                      </div>
                    </div>
                    <div className="col-md-6 mt-3">
                    <div className="form-group">
