...
var { Student } = require('../models/student')
 ...
 router.get('/students-azad-jammu-kashmir', (req, res) => {
...
router.get('/students-balochistan', (req, res) => {
...
router.get('/students-gilgit-baltistan', (req, res) => {
...
router.get('/students-khyber-pakhtunkhwa', (req, res) => {
...
router.get('/students-punjab', (req, res) => {
...
router.get('/students-sindh', (req, res) => {
...
router.get("/specific/:email", (req, res) => {
...
router.get("/specific/id/:id", (req, res) => {
