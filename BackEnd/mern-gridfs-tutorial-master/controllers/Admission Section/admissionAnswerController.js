...
router.get('/MCQ-answers', (req, res) => {
...
router.get('/Blanks-answers', (req, res) => {
...
router.get('/HandWriting-answers', (req, res) => {
...
router.get('/Pronunciation-answers', (req, res) => {
